...
int main(void)
{
    ...
    while (1)
    {
        ...
        for (uint8_t i = 0U;
             i < ADC_FILTER_SAMPLES;
             i++)
        {
            adc_sum += Joystick_Read();
         ...
         * USE COMMON RANGE
         *
         * This makes the speed mapping equal in both
         * directions.
         * ==================================================== */

        if (left_range < right_range)
        {
            common_range = left_range;
        }
        else
        {
            common_range = right_range;
        }
            ...
            (int32_t)JOYSTICK_DEADZONE)
        {
            ...
            if (distance > common_range)
            {
                distance = common_range;
            }
